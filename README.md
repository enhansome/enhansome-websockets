...
* [Centrifugo](https://github.com/centrifugal/centrifugo) ⭐ 10,633 | 🐛 24 | 🌐 Go | 📅 2026-08-12 - Scalable real-time messaging in language-agnostic way.
...
* [mongoose](https://github.com/cesanta/mongoose) ⭐ 12,994 | 🐛 4 | 🌐 C | 📅 2026-08-15 - Mongoose Embedded Web Server Library - Mongoose is more than an embedded webserver. It is a multi-protocol embedded networking library with functions including TCP, HTTP client and server, WebSocket client and server, MQTT client and broker and much more.
* [civetweb](https://github.com/civetweb/civetweb) ⭐ 3,434 | 🐛 235 | 🌐 C | 📅 2026-08-01 - Embedded C/C++ web server with WebSocket client and server support, easy to integrate.
* [Wslay](https://github.com/tatsuhiro-t/wslay) ⭐ 670 | 🐛 32 | 🌐 C | 📅 2022-08-25 - Designed to be embedded in other programs; freedom to choose your own network I/O. Event-based API, as well as synchronous frame-based.
...
* [µWebSockets](https://github.com/uNetworking/uWebSockets) ⭐ 18,954 | 🐛 48 | 🌐 C++ | 📅 2026-08-16 -  Highly scalable WebSocket server library.
...
* [POCO](https://github.com/pocoproject/poco) ⭐ 9,472 | 🐛 125 | 🌐 C++ | 📅 2026-08-05 - C++ libraries for network-centric applications, including HTTP and WebSocket classes.
...
* [IXWebSocket](https://github.com/machinezone/IXWebSocket) ⭐ 787 | 🐛 70 | 🌐 C++ | 📅 2026-07-15 - Lightweight C++11 multi-threaded client library with TLS support.
...
* [Arsd:CGI](https://github.com/adamdruppe/arsd) ⭐ 562 | 🐛 53 | 🌐 D | 📅 2026-06-28 - Uniform server-side API for CGI, FastCGI, SCGI, and HTTP web applications. Offers both lower- and higher- level api options among other common (optional) things like websocket and event source serving support.
...
* [Phoenix](https://github.com/phoenixframework/phoenix) ⭐ 23,120 | 🐛 50 | 🌐 Elixir | 📅 2026-08-12 - Productive Elixir web framework with Channels for realtime, scalable WebSocket communication.
* [Phoenix LiveView](https://github.com/phoenixframework/phoenix_live_view) ⭐ 6,824 | 🐛 49 | 🌐 Elixir | 📅 2026-08-16 - Rich, realtime server-rendered UIs over WebSockets without writing JavaScript.
* [Bandit](https://github.com/mtrudel/bandit) ⭐ 1,909 | 🐛 22 | 🌐 Elixir | 📅 2026-08-03 - Pure-Elixir HTTP and WebSocket server built for Plug and WebSock.
...
* [Gorilla Websocket](https://github.com/gorilla/websocket) ⭐ 24,844 | 🐛 78 | 🌐 Go | 📅 2025-03-19 - WebSocket implementation for Go.
...
* [coder/websocket](https://github.com/coder/websocket) ⭐ 5,404 | 🐛 70 | 🌐 Go | 📅 2026-06-15 - A minimal and idiomatic WebSocket library for Go (formerly nhooyr/websocket).
...
* [nbio](https://github.com/lesismal/nbio) ⭐ 2,754 | 🐛 0 | 🌐 Go | 📅 2026-08-09 - Non-blocking, event-driven networking framework with high-performance WebSocket support and low memory usage.
...
* [Centrifuge](https://github.com/centrifugal/centrifuge) ⭐ 1,459 | 🐛 13 | 🌐 Go | 📅 2026-08-12 - Real-time messaging library for Go with scalability in mind.
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 128 | 🐛 30 | 🌐 TypeScript | 📅 2026-08-17 - AI-powered multi-cluster Kubernetes dashboard using WebSockets for real-time cluster communication and live observability streams.
...
* [http-kit](https://github.com/http-kit/http-kit) ⭐ 2,562 | 🐛 51 | 🌐 Java | 📅 2026-07-31 - Minimalist, high-performance HTTP server and client with async WebSocket support.
...
* [Netty](https://github.com/netty/netty) ⭐ 35,032 | 🐛 659 | 🌐 Java | 📅 2026-08-17 - Asynchronous event-driven network framework with full WebSocket codec support.
* [Vert.x](https://github.com/eclipse-vertx/vert.x) ⭐ 14,683 | 🐛 230 | 🌐 Java | 📅 2026-08-13 - Reactive, polyglot toolkit for the JVM with first-class WebSocket client and server APIs.
* [Java-WebSocket](https://github.com/TooTallNate/Java-WebSocket) ⭐ 10,809 | 🐛 58 | 🌐 Java | 📅 2026-01-13 - Barebones WebSocket client and server implementation written in 100% Java.
* [Javalin](https://github.com/javalin/javalin) ⭐ 8,336 | 🐛 15 | 🌐 Kotlin | 📅 2026-08-15 - Lightweight web framework for Java and Kotlin with simple WebSocket handlers.
* [Jetty](https://github.com/jetty/jetty.project) ⭐ 4,092 | 🐛 280 | 🌐 Java | 📅 2026-08-17 - Lightweight, embeddable Java web server and servlet container with Jakarta and native WebSocket support.
* [Atmosphere](https://github.com/Atmosphere/atmosphere) ⭐ 3,795 | 🐛 6 | 🌐 Java | 📅 2026-08-17 - Realtime Client Server Framework for the JVM, supporting WebSockets with Cross-Browser Fallbacks.
...
* [OkHttp](https://github.com/square/okhttp) ⭐ 47,049 | 🐛 135 | 🌐 Kotlin | 📅 2026-08-17 - HTTP client for the JVM and Android with a robust WebSocket client.
...
* [Scarlet](https://github.com/Tinder/Scarlet) ⭐ 3,253 | 🐛 108 | 🌐 Kotlin | 📅 2025-11-21 - Tinder's Retrofit inspired WebSocket client for Kotlin, Java, and Android.
...
* [ZIO HTTP](https://github.com/zio/zio-http) ⭐ 869 | 🐛 54 | 🌐 Scala | 📅 2026-08-17 - High-performance, functional Scala HTTP library with WebSocket support built on ZIO.
* [Apache Pekko HTTP](https://github.com/apache/pekko-http) ⭐ 195 | 🐛 51 | 🌐 Scala | 📅 2026-08-17 - Streaming WebSocket client and server directives; the Apache-licensed Akka HTTP fork.
...
* [HTTP.jl](https://github.com/JuliaWeb/HTTP.jl) ⭐ 688 | 🐛 5 | 🌐 Julia | 📅 2026-08-16 - HTTP library for Julia with support on Websockets.
...
* [FastAPI](https://github.com/fastapi/fastapi) ⭐ 101,629 | 🐛 87 | 🌐 Python | 📅 2026-08-17 - Modern, high-performance web framework for building APIs, with first-class WebSocket support.
* [aiohttp](https://github.com/aio-libs/aiohttp) ⭐ 16,523 | 🐛 244 | 🌐 Python | 📅 2026-08-17 - Asynchronous HTTP client/server framework for asyncio, with built-in WebSocket client and server support.
...
* [python-socketio](https://github.com/miguelgrinberg/python-socketio) ⭐ 4,368 | 🐛 13 | 🌐 Python | 📅 2026-08-09 - Python implementation of the Socket.IO realtime client and server.
...
* [httpuv](https://cran.r-project.org/package=httpuv) - Provides low-level socket and protocol support for WebSocket (and HTTP) servers in R. Built on top of the [libuv](https://github.com/libuv/libuv) ⭐ 27,111 | 🐛 228 | 🌐 C | 📅 2026-08-17 and [http-parser](https://github.com/nodejs/http-parser) ⚠️ Archived C libraries.
...
* [Rage](https://github.com/rage-rb/rage) ⭐ 1,407 | 🐛 21 | 🌐 Ruby | 📅 2026-08-13 - Fast WebSocket server compatible with Action Cable.
...
* [Axum](https://github.com/tokio-rs/axum) ⭐ 26,891 | 🐛 75 | 🌐 Rust | 📅 2026-08-15 - Ergonomic and modular web framework built with Tokio, Tower, and Hyper, with built-in WebSocket support.
* [warp](https://github.com/seanmonstar/warp) ⭐ 10,360 | 🐛 232 | 🌐 Rust | 📅 2026-07-28 - Composable, Tokio-based web server framework with a WebSocket filter.
* [ntex](https://github.com/ntex-rs/ntex) ⭐ 2,528 | 🐛 3 | 🌐 Rust | 📅 2026-08-16 - Powerful, pragmatic and fast web framework with WebSocket support.
...
* [Fastwebsockets](https://github.com/denoland/fastwebsockets) ⭐ 1,131 | 🐛 19 | 🌐 Rust | 📅 2026-07-31 - A fast RFC6455 WebSocket server implementation
...
* [Hummingbird](https://github.com/hummingbird-project/hummingbird) ⭐ 1,872 | 🐛 23 | 🌐 Swift | 📅 2026-08-16 - Lightweight, flexible Swift server framework on SwiftNIO with WebSocket support.
...
* [TikTok-Live-Connector](https://github.com/zerodytrash/TikTok-Live-Connector/) ⭐ 2,117 | 🐛 9 | 🌐 TypeScript | 📅 2026-07-24 - Open source TikTok LIVE stream events API, with delivery over WebSocket. The predominant & native TypeScript library for TikTok LIVE integrations.
...
Please, read the [Contribution Guidelines](https://github.com/facundofarias/awesome-websockets/blob/master/CONTRIBUTING.md) ⭐ 1,858 | 🐛 4 | 📅 2026-07-13 before submitting your suggestion.

Feel free to [open an issue](https://github.com/facundofarias/awesome-websockets/issues) ⭐ 1,858 | 🐛 4 | 📅 2026-07-13 or [create a pull request](https://github.com/facundofarias/awesome-websockets/pulls) ⭐ 1,858 | 🐛 4 | 📅 2026-07-13 with your additions.
