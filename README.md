...
* [Centrifugo](https://github.com/centrifugal/centrifugo) ⭐ 10,627 | 🐛 23 | 🌐 Go | 📅 2026-08-12 - Scalable real-time messaging in language-agnostic way.
* [SocketCluster](https://github.com/SocketCluster/socketcluster) ⭐ 6,194 | 🐛 101 | 🌐 JavaScript | 📅 2026-05-27 - Scalable pub/sub WebSocket framework with support for horizontal scaling across multiple hosts and processes.
* [gwsocket](https://github.com/allinurl/gwsocket) ⭐ 815 | 🐛 12 | 🌐 C | 📅 2026-07-06 - Fast, standalone, language-agnostic WebSocket server RFC6455 compliant.
* [MinnowServer](https://github.com/RealTimeLogic/MinnowServer) ⭐ 337 | 🐛 2 | 🌐 C | 📅 2024-09-23 - A super small and fast embedded HTTP(S) WebSocket server.
...
* [mongoose](https://github.com/cesanta/mongoose) ⭐ 12,992 | 🐛 4 | 🌐 C | 📅 2026-08-15 - Mongoose Embedded Web Server Library - Mongoose is more than an embedded webserver. It is a multi-protocol embedded networking library with functions including TCP, HTTP client and server, WebSocket client and server, MQTT client and broker and much more.
* [civetweb](https://github.com/civetweb/civetweb) ⭐ 3,433 | 🐛 234 | 🌐 C | 📅 2026-08-01 - Embedded C/C++ web server with WebSocket client and server support, easy to integrate.
* [Wslay](https://github.com/tatsuhiro-t/wslay) ⭐ 669 | 🐛 32 | 🌐 C | 📅 2022-08-25 - Designed to be embedded in other programs; freedom to choose your own network I/O. Event-based API, as well as synchronous frame-based.
...
* [µWebSockets](https://github.com/uNetworking/uWebSockets) ⭐ 18,953 | 🐛 48 | 🌐 C++ | 📅 2026-08-16 -  Highly scalable WebSocket server library.
* [Drogon](https://github.com/an-tao/drogon) ⭐ 14,186 | 🐛 423 | 🌐 C++ | 📅 2026-08-11 - Fast C++14/17/20 HTTP application framework with built-in WebSocket controllers.
* [POCO](https://github.com/pocoproject/poco) ⭐ 9,472 | 🐛 124 | 🌐 C++ | 📅 2026-08-05 - C++ libraries for network-centric applications, including HTTP and WebSocket classes.
* [Oat++](https://github.com/oatpp/oatpp) ⭐ 8,643 | 🐛 333 | 🌐 C++ | 📅 2025-11-12 - Light and powerful C++ web framework with async WebSocket support and zero dependencies.
* [Websocketpp](https://github.com/zaphoyd/websocketpp) ⭐ 7,710 | 🐛 483 | 🌐 C++ | 📅 2026-05-04 - C++ Websocket client/server library.
* [libhv](https://github.com/ithewei/libhv) ⭐ 7,536 | 🐛 40 | 🌐 C | 📅 2026-08-06 - A network library for developing TCP/UDP/SSL/HTTP/WebSocket client/server.
* [Crow](https://github.com/CrowCpp/Crow) ⭐ 4,951 | 🐛 88 | 🌐 C++ | 📅 2026-08-14 - Fast and easy-to-use C++ microframework for the web, with WebSocket support.
...
* [IXWebSocket](https://github.com/machinezone/IXWebSocket) ⭐ 785 | 🐛 70 | 🌐 C++ | 📅 2026-07-15 - Lightweight C++11 multi-threaded client library with TLS support.
...
* [websocket-client](https://github.com/Marfusios/websocket-client) ⭐ 758 | 🐛 57 | 🌐 C# | 📅 2026-05-19 - Reactive, reconnecting WebSocket client for .NET based on System.Net.WebSockets.
...
* [Vibe.d](https://github.com/vibe-d/vibe.d) ⭐ 1,213 | 🐛 451 | 🌐 D | 📅 2026-07-04 - High-performance asynchronous I/O, concurrency and web application toolkit written in D.
...
* [Serverino](https://github.com/trikko/serverino) ⭐ 79 | 🐛 1 | 🌐 D | 📅 2026-05-21 - Small and ready-to-go http server. Support for websockets included.
...
* [Phoenix](https://github.com/phoenixframework/phoenix) ⭐ 23,118 | 🐛 49 | 🌐 Elixir | 📅 2026-08-12 - Productive Elixir web framework with Channels for realtime, scalable WebSocket communication.
* [Phoenix LiveView](https://github.com/phoenixframework/phoenix_live_view) ⭐ 6,823 | 🐛 51 | 🌐 Elixir | 📅 2026-08-14 - Rich, realtime server-rendered UIs over WebSockets without writing JavaScript.
* [Bandit](https://github.com/mtrudel/bandit) ⭐ 1,907 | 🐛 21 | 🌐 Elixir | 📅 2026-08-03 - Pure-Elixir HTTP and WebSocket server built for Plug and WebSock.
* [WebSockex](https://github.com/Azolo/websockex) ⭐ 558 | 🐛 22 | 🌐 Elixir | 📅 2025-12-01 - Elixir WebSocket client library built on top of GenServer.

### Erlang

* [Cowboy](https://github.com/ninenines/cowboy) ⭐ 7,524 | 🐛 63 | 🌐 Erlang | 📅 2026-07-28 - Small, fast, modular HTTP server written in Erlang.
* [n2o](https://github.com/synrc/n2o) ⭐ 1,342 | 🐛 1 | 🌐 Erlang | 📅 2026-06-04 - Erlang web server on websockets.
* [Gun](https://github.com/ninenines/gun) ⭐ 947 | 🐛 24 | 🌐 Erlang | 📅 2026-07-28 - Erlang HTTP/1.1, HTTP/2 and WebSocket client library.
...
* [Gorilla Websocket](https://github.com/gorilla/websocket) ⭐ 24,846 | 🐛 78 | 🌐 Go | 📅 2025-03-19 - WebSocket implementation for Go.
* [Ws](https://github.com/gobwas/ws) ⭐ 6,463 | 🐛 28 | 🌐 Go | 📅 2026-02-12 - Tiny WebSocket library for Go.
* [1m-go-websockets](https://github.com/eranyanay/1m-go-websockets) ⭐ 5,997 | 🐛 3 | 🌐 Go | 📅 2022-08-14 - Handling 1M websockets connections in Go.
...
* [coder/websocket](https://github.com/coder/websocket) ⭐ 5,402 | 🐛 70 | 🌐 Go | 📅 2026-06-15 - A minimal and idiomatic WebSocket library for Go (formerly nhooyr/websocket).
...
* [nbio](https://github.com/lesismal/nbio) ⭐ 2,753 | 🐛 0 | 🌐 Go | 📅 2026-08-09 - Non-blocking, event-driven networking framework with high-performance WebSocket support and low memory usage.
* [GWS](https://github.com/lxzan/gws) ⭐ 1,795 | 🐛 0 | 🌐 Go | 📅 2026-07-27 - Simple, fast, reliable websocket server & client, supports running over tcp/kcp/unix domain socket.
* [Centrifuge](https://github.com/centrifugal/centrifuge) ⭐ 1,458 | 🐛 13 | 🌐 Go | 📅 2026-08-12 - Real-time messaging library for Go with scalability in mind.
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 128 | 🐛 37 | 🌐 TypeScript | 📅 2026-08-16 - AI-powered multi-cluster Kubernetes dashboard using WebSockets for real-time cluster communication and live observability streams.
...
* [http-kit](https://github.com/http-kit/http-kit) ⭐ 2,566 | 🐛 50 | 🌐 Java | 📅 2026-07-31 - Minimalist, high-performance HTTP server and client with async WebSocket support.
* [Sente](https://github.com/ptaoussanis/sente) ⭐ 1,788 | 🐛 3 | 🌐 Clojure | 📅 2026-08-06 - Realtime web comms for Clojure/Script.
...
* [Netty](https://github.com/netty/netty) ⭐ 35,031 | 🐛 663 | 🌐 Java | 📅 2026-08-15 - Asynchronous event-driven network framework with full WebSocket codec support.
* [Vert.x](https://github.com/eclipse-vertx/vert.x) ⭐ 14,683 | 🐛 226 | 🌐 Java | 📅 2026-08-13 - Reactive, polyglot toolkit for the JVM with first-class WebSocket client and server APIs.
* [Java-WebSocket](https://github.com/TooTallNate/Java-WebSocket) ⭐ 10,810 | 🐛 58 | 🌐 Java | 📅 2026-01-13 - Barebones WebSocket client and server implementation written in 100% Java.
* [Javalin](https://github.com/javalin/javalin) ⭐ 8,335 | 🐛 14 | 🌐 Kotlin | 📅 2026-08-15 - Lightweight web framework for Java and Kotlin with simple WebSocket handlers.
* [Jetty](https://github.com/jetty/jetty.project) ⭐ 4,092 | 🐛 278 | 🌐 Java | 📅 2026-08-16 - Lightweight, embeddable Java web server and servlet container with Jakarta and native WebSocket support.
* [Atmosphere](https://github.com/Atmosphere/atmosphere) ⭐ 3,795 | 🐛 6 | 🌐 Java | 📅 2026-08-15 - Realtime Client Server Framework for the JVM, supporting WebSockets with Cross-Browser Fallbacks.
* [Undertow](https://github.com/undertow-io/undertow) ⭐ 3,757 | 🐛 44 | 🌐 Java | 📅 2026-08-14 - High-performance web server (WildFly's core) with a dedicated WebSocket API.
...
* [Webbit](https://github.com/webbit/webbit) ⭐ 818 | 🐛 47 | 🌐 Java | 📅 2023-12-17 - Java event based WebSocket and HTTP server.
...
* [OkHttp](https://github.com/square/okhttp) ⭐ 47,048 | 🐛 133 | 🌐 Kotlin | 📅 2026-08-15 - HTTP client for the JVM and Android with a robust WebSocket client.
* [Ktor](https://github.com/ktorio/ktor) ⭐ 14,499 | 🐛 194 | 🌐 Kotlin | 📅 2026-08-14 - JetBrains' Kotlin async framework with built-in WebSocket client and server support.
* [Scarlet](https://github.com/Tinder/Scarlet) ⭐ 3,254 | 🐛 108 | 🌐 Kotlin | 📅 2025-11-21 - Tinder's Retrofit inspired WebSocket client for Kotlin, Java, and Android.

#### Scala

* [http4s](https://github.com/http4s/http4s) ⭐ 2,625 | 🐛 379 | 🌐 Scala | 📅 2026-08-11 - Typeful, functional, streaming HTTP for Scala with WebSocket support.
* [ZIO HTTP](https://github.com/zio/zio-http) ⭐ 869 | 🐛 54 | 🌐 Scala | 📅 2026-08-15 - High-performance, functional Scala HTTP library with WebSocket support built on ZIO.
* [Apache Pekko HTTP](https://github.com/apache/pekko-http) ⭐ 195 | 🐛 51 | 🌐 Scala | 📅 2026-08-15 - Streaming WebSocket client and server directives; the Apache-licensed Akka HTTP fork.
...
* [HTTP.jl](https://github.com/JuliaWeb/HTTP.jl) ⭐ 688 | 🐛 5 | 🌐 Julia | 📅 2026-08-15 - HTTP library for Julia with support on Websockets.
* [WebSockets.jl](https://github.com/JuliaWeb/WebSockets.jl) ⭐ 162 | 🐛 9 | 🌐 Julia | 📅 2022-11-29 - A WebSockets library for Julia.

### Node.js / JavaScript

* [Ws](https://github.com/websockets/ws) ⭐ 22,791 | 🐛 5 | 🌐 JavaScript | 📅 2026-08-13 - `ws`: The fastest cross platform RFC-6455 WebSocket implementation for Node.js.
* [uws](https://github.com/uNetworking/uWebSockets.js) ⭐ 9,145 | 🐛 19 | 🌐 C++ | 📅 2026-07-11 - Tiny WebSockets (access to the C++ library, µWebSockets, via Node.js)
* [PartySocket](https://github.com/partykit/partykit/tree/main/packages/partysocket) ⭐ 5,685 | 🐛 92 | 🌐 TypeScript | 📅 2026-01-29 - Robust WebSocket client with automatic reconnection and buffering, usable against any WS server.
* [soketi](https://github.com/soketi/soketi) ⭐ 5,634 | 🐛 140 | 🌐 TypeScript | 📅 2025-03-03 - Just another simple, fast, and resilient open-source WebSockets server. Built on top of uWebSockets.js.
* [WebSocket-Node](https://github.com/theturtle32/WebSocket-Node) ⭐ 3,782 | 🐛 74 | 🌐 JavaScript | 📅 2025-10-06 - WebSocket Implementation for Node.JS (Draft -08 through the final RFC 6455).
...
* [Sockjs-node](https://github.com/sockjs/sockjs-node) ⭐ 2,102 | 🐛 19 | 🌐 JavaScript | 📅 2026-07-21 - WebSocket emulation - Node.js server.
...
* [y-websocket](https://github.com/yjs/y-websocket) ⭐ 712 | 🐛 38 | 🌐 JavaScript | 📅 2026-08-06 - WebSocket connection provider for Yjs, enabling real-time collaborative editing and CRDT sync.
* [rpc-websockets](https://github.com/elpheria/rpc-websockets) ⭐ 625 | 🐛 15 | 🌐 JavaScript | 📅 2026-05-15 - JSON-RPC 2.0 implementation over WebSockets for Node.js and JavaScript/TypeScript.
* [faye-websocket-node](https://github.com/faye/faye-websocket-node) ⭐ 613 | 🐛 5 | 🌐 JavaScript | 📅 2023-09-07 - Standards-compliant WebSocket client and server.
* [websocket-as-promised](https://github.com/vitalets/websocket-as-promised) ⭐ 600 | 🐛 6 | 🌐 JavaScript | 📅 2025-04-22 - Promise-based W3C WebSocket wrapper: allows to use promises when connecting, disconnecting and messaging with WebSocket server.
...
* [FastAPI](https://github.com/fastapi/fastapi) ⭐ 101,619 | 🐛 87 | 🌐 Python | 📅 2026-08-15 - Modern, high-performance web framework for building APIs, with first-class WebSocket support.
* [aiohttp](https://github.com/aio-libs/aiohttp) ⭐ 16,523 | 🐛 238 | 🌐 Python | 📅 2026-08-15 - Asynchronous HTTP client/server framework for asyncio, with built-in WebSocket client and server support.
* [Websockets](https://websockets.readthedocs.io) ([code](https://github.com/aaugustin/websockets) ⭐ 5,713 | 🐛 0 | 🌐 Python | 📅 2026-08-10) - Websockets is a library for developing WebSocket servers and clients in Python 3.
* [python-socketio](https://github.com/miguelgrinberg/python-socketio) ⭐ 4,369 | 🐛 13 | 🌐 Python | 📅 2026-08-09 - Python implementation of the Socket.IO realtime client and server.
* [websocket-client](https://github.com/websocket-client/websocket-client) ⭐ 3,711 | 🐛 34 | 🌐 Python | 📅 2026-05-04 - Popular, long-standing synchronous client for Python.
* [Autobahn.ws](https://github.com/crossbario/autobahn-python) ⭐ 2,541 | 🐛 187 | 🌐 Python | 📅 2026-07-15 - Open-source real-time framework for Web, Mobile & Internet of Things.
* [Socketify.py](https://github.com/cirospaciari/socketify.py) ⭐ 1,714 | 🐛 53 | 🌐 Python | 📅 2025-09-23 - Fast WebSocket and HTTP server for Python built on uWebSockets, with ASGI/WSGI support.
...
* [simple-websocket](https://github.com/miguelgrinberg/simple-websocket) ⭐ 88 | 🐛 6 | 🌐 Python | 📅 2026-05-14 - Simple WebSocket server and client for Python built on WSGI/ASGI.
...
* [httpuv](https://cran.r-project.org/package=httpuv) - Provides low-level socket and protocol support for WebSocket (and HTTP) servers in R. Built on top of the [libuv](https://github.com/libuv/libuv) ⭐ 27,101 | 🐛 226 | 🌐 C | 📅 2026-08-06 and [http-parser](https://github.com/nodejs/http-parser) ⚠️ Archived C libraries.
...
* [websocket-rails](https://github.com/websocket-rails/websocket-rails) ⭐ 1,715 | 🐛 200 | 🌐 Ruby | 📅 2024-02-14 - Plug and play websocket support for ruby on rails.
* [Em-websocket](https://github.com/igrigorik/em-websocket) ⭐ 1,689 | 🐛 26 | 🌐 Ruby | 📅 2021-11-11 - EventMachine based WebSocket server.
* [Slanger](https://github.com/stevegraham/slanger) ⚠️ Archived - Open Pusher implementation compatible with Pusher libraries.
* [Rage](https://github.com/rage-rb/rage) ⭐ 1,407 | 🐛 20 | 🌐 Ruby | 📅 2026-08-13 - Fast WebSocket server compatible with Action Cable.
* [render\_sync](https://github.com/chrismccord/render_sync) ⭐ 1,385 | 🐛 39 | 🌐 Ruby | 📅 2019-05-25 - Real-time Rails Partials.
...
* [Iodine](https://github.com/boazsegev/iodine) ⭐ 971 | 🐛 22 | 🌐 C | 📅 2026-08-12 - WebSocket/HTTP server with integrated pub/sub and optional Redis support.
...
* [Axum](https://github.com/tokio-rs/axum) ⭐ 26,883 | 🐛 75 | 🌐 Rust | 📅 2026-08-15 - Ergonomic and modular web framework built with Tokio, Tower, and Hyper, with built-in WebSocket support.
* [warp](https://github.com/seanmonstar/warp) ⭐ 10,357 | 🐛 232 | 🌐 Rust | 📅 2026-07-28 - Composable, Tokio-based web server framework with a WebSocket filter.
* [ntex](https://github.com/ntex-rs/ntex) ⭐ 2,529 | 🐛 2 | 🌐 Rust | 📅 2026-08-15 - Powerful, pragmatic and fast web framework with WebSocket support.
* [Tokio-Tungstenite](https://github.com/snapview/tokio-tungstenite) ⭐ 2,494 | 🐛 17 | 🌐 Rust | 📅 2026-07-11 - Tokio binding for Tungstenite, the Lightweight stream-based WebSocket implementation
* [Tungstenite](https://github.com/snapview/tungstenite-rs) ⭐ 2,381 | 🐛 46 | 🌐 Rust | 📅 2026-07-11 - Lightweight stream-based WebSocket implementation
* [rust-websocket](https://github.com/websockets-rs/rust-websocket) ⭐ 1,612 | 🐛 45 | 🌐 Rust | 📅 2023-09-17 - RFC6455 library providing both synchronous and asynchronous client and server.
* [Fastwebsockets](https://github.com/denoland/fastwebsockets) ⭐ 1,132 | 🐛 19 | 🌐 Rust | 📅 2026-07-31 - A fast RFC6455 WebSocket server implementation
...
* [wtx](https://github.com/c410-f3r/wtx) ⭐ 394 | 🐛 8 | 🌐 Rust | 📅 2026-08-14 - Client and server with encryption support.
...
* [Starscream](https://github.com/daltoniam/Starscream) ⭐ 8,645 | 🐛 172 | 🌐 Swift | 📅 2024-05-16 - Conforming WebSocket (RFC 6455) client library in Swift for iOS and macOS.
* [SwiftNIO](https://github.com/apple/swift-nio) ⭐ 8,507 | 🐛 287 | 🌐 Swift | 📅 2026-08-13 - Apple's cross-platform async event-driven network framework, a foundation for WebSocket servers.
* [socket.io-client-swift](https://github.com/socketio/socket.io-client-swift) ⭐ 5,293 | 🐛 259 | 🌐 Swift | 📅 2024-10-01 - Official Socket.IO client for Swift.
* [Hummingbird](https://github.com/hummingbird-project/hummingbird) ⭐ 1,869 | 🐛 23 | 🌐 Swift | 📅 2026-08-16 - Lightweight, flexible Swift server framework on SwiftNIO with WebSocket support.
...
* [TikTok-Live-Connector](https://github.com/zerodytrash/TikTok-Live-Connector/) ⭐ 2,115 | 🐛 9 | 🌐 TypeScript | 📅 2026-07-24 - Open source TikTok LIVE stream events API, with delivery over WebSocket. The predominant & native TypeScript library for TikTok LIVE integrations.
* [TikTokLive](https://github.com/isaackogan/TikTokLive/) ⭐ 1,527 | 🐛 1 | 🌐 Python | 📅 2026-08-13 - A TikTok LIVE API Client built in Python, with strict mypy type safety & a copyleft license. Real-time TikTok LIVE stream events (gifts, chats, etc.) over WebSocket.
* [TikTokLiveJava](https://github.com/jwdeveloper/TikTokLiveJava) ⭐ 207 | 🐛 1 | 🌐 Java | 📅 2026-08-13 - A TikTok LIVE API Client built in Java. Real-time TikTok LIVE stream events (gifts, chats, etc.) over WebSockets.
...
* [PartyKit](https://github.com/partykit/partykit) ⭐ 5,685 | 🐛 92 | 🌐 TypeScript | 📅 2026-01-29 - Open-source platform for building realtime multiplayer apps on Cloudflare with a batteries-included WebSocket server abstraction.
...
* [react-use-websocket](https://github.com/robtaussig/react-use-websocket) ⭐ 1,888 | 🐛 95 | 🌐 TypeScript | 📅 2025-02-04 - React hook for WebSocket connections with reconnection, message queueing, and shared connections.
...
* [websocat](https://github.com/vi/websocat) ⭐ 8,659 | 🐛 158 | 🌐 Rust | 📅 2026-08-13 - Command-line client for WebSockets, like netcat (or curl) for ws\:// with advanced socat-like functions.
* [wscat](https://github.com/websockets/wscat) ⭐ 2,771 | 🐛 36 | 🌐 JavaScript | 📅 2025-05-03 - WebSocket cat.
...
Please, read the [Contribution Guidelines](https://github.com/facundofarias/awesome-websockets/blob/master/CONTRIBUTING.md) ⭐ 1,858 | 🐛 3 | 📅 2026-07-13 before submitting your suggestion.

Feel free to [open an issue](https://github.com/facundofarias/awesome-websockets/issues) ⭐ 1,858 | 🐛 3 | 📅 2026-07-13 or [create a pull request](https://github.com/facundofarias/awesome-websockets/pulls) ⭐ 1,858 | 🐛 3 | 📅 2026-07-13 with your additions.
