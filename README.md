...
* [Centrifugo](https://github.com/centrifugal/centrifugo) ⭐ 10,635 | 🐛 24 | 🌐 Go | 📅 2026-08-18 - Scalable real-time messaging in language-agnostic way.
...
* [µWebSockets](https://github.com/uNetworking/uWebSockets) ⭐ 18,957 | 🐛 48 | 🌐 C++ | 📅 2026-08-17 -  Highly scalable WebSocket server library.
* [Drogon](https://github.com/an-tao/drogon) ⭐ 14,186 | 🐛 425 | 🌐 C++ | 📅 2026-08-11 - Fast C++14/17/20 HTTP application framework with built-in WebSocket controllers.
* [POCO](https://github.com/pocoproject/poco) ⭐ 9,472 | 🐛 127 | 🌐 C++ | 📅 2026-08-18 - C++ libraries for network-centric applications, including HTTP and WebSocket classes.
* [Oat++](https://github.com/oatpp/oatpp) ⭐ 8,642 | 🐛 333 | 🌐 C++ | 📅 2025-11-12 - Light and powerful C++ web framework with async WebSocket support and zero dependencies.
* [Websocketpp](https://github.com/zaphoyd/websocketpp) ⭐ 7,710 | 🐛 483 | 🌐 C++ | 📅 2026-05-04 - C++ Websocket client/server library.
* [libhv](https://github.com/ithewei/libhv) ⭐ 7,536 | 🐛 40 | 🌐 C | 📅 2026-08-17 - A network library for developing TCP/UDP/SSL/HTTP/WebSocket client/server.
* [Crow](https://github.com/CrowCpp/Crow) ⭐ 4,951 | 🐛 90 | 🌐 C++ | 📅 2026-08-17 - Fast and easy-to-use C++ microframework for the web, with WebSocket support.
...
* [IXWebSocket](https://github.com/machinezone/IXWebSocket) ⭐ 787 | 🐛 69 | 🌐 C++ | 📅 2026-08-18 - Lightweight C++11 multi-threaded client library with TLS support.
...
* [Phoenix](https://github.com/phoenixframework/phoenix) ⭐ 23,121 | 🐛 50 | 🌐 Elixir | 📅 2026-08-12 - Productive Elixir web framework with Channels for realtime, scalable WebSocket communication.
* [Phoenix LiveView](https://github.com/phoenixframework/phoenix_live_view) ⭐ 6,825 | 🐛 48 | 🌐 Elixir | 📅 2026-08-17 - Rich, realtime server-rendered UIs over WebSockets without writing JavaScript.
* [Bandit](https://github.com/mtrudel/bandit) ⭐ 1,909 | 🐛 24 | 🌐 Elixir | 📅 2026-08-03 - Pure-Elixir HTTP and WebSocket server built for Plug and WebSock.
...
* [Gorilla Websocket](https://github.com/gorilla/websocket) ⭐ 24,843 | 🐛 78 | 🌐 Go | 📅 2025-03-19 - WebSocket implementation for Go.
...
* [coder/websocket](https://github.com/coder/websocket) ⭐ 5,409 | 🐛 70 | 🌐 Go | 📅 2026-06-15 - A minimal and idiomatic WebSocket library for Go (formerly nhooyr/websocket).
...
* [Centrifuge](https://github.com/centrifugal/centrifuge) ⭐ 1,459 | 🐛 13 | 🌐 Go | 📅 2026-08-17 - Real-time messaging library for Go with scalability in mind.
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 128 | 🐛 41 | 🌐 TypeScript | 📅 2026-08-18 - AI-powered multi-cluster Kubernetes dashboard using WebSockets for real-time cluster communication and live observability streams.
...
* [http-kit](https://github.com/http-kit/http-kit) ⭐ 2,562 | 🐛 52 | 🌐 Java | 📅 2026-07-31 - Minimalist, high-performance HTTP server and client with async WebSocket support.
...
* [Netty](https://github.com/netty/netty) ⭐ 35,036 | 🐛 662 | 🌐 Java | 📅 2026-08-17 - Asynchronous event-driven network framework with full WebSocket codec support.
* [Vert.x](https://github.com/eclipse-vertx/vert.x) ⭐ 14,684 | 🐛 230 | 🌐 Java | 📅 2026-08-17 - Reactive, polyglot toolkit for the JVM with first-class WebSocket client and server APIs.
...
* [Javalin](https://github.com/javalin/javalin) ⭐ 8,337 | 🐛 15 | 🌐 Kotlin | 📅 2026-08-15 - Lightweight web framework for Java and Kotlin with simple WebSocket handlers.
* [Jetty](https://github.com/jetty/jetty.project) ⭐ 4,092 | 🐛 279 | 🌐 Java | 📅 2026-08-18 - Lightweight, embeddable Java web server and servlet container with Jakarta and native WebSocket support.
* [Atmosphere](https://github.com/Atmosphere/atmosphere) ⭐ 3,796 | 🐛 6 | 🌐 Java | 📅 2026-08-17 - Realtime Client Server Framework for the JVM, supporting WebSockets with Cross-Browser Fallbacks.
* [Undertow](https://github.com/undertow-io/undertow) ⭐ 3,757 | 🐛 45 | 🌐 Java | 📅 2026-08-14 - High-performance web server (WildFly's core) with a dedicated WebSocket API.
...
* [OkHttp](https://github.com/square/okhttp) ⭐ 47,051 | 🐛 136 | 🌐 Kotlin | 📅 2026-08-17 - HTTP client for the JVM and Android with a robust WebSocket client.
* [Ktor](https://github.com/ktorio/ktor) ⭐ 14,500 | 🐛 190 | 🌐 Kotlin | 📅 2026-08-17 - JetBrains' Kotlin async framework with built-in WebSocket client and server support.
...
* [http4s](https://github.com/http4s/http4s) ⭐ 2,625 | 🐛 380 | 🌐 Scala | 📅 2026-08-18 - Typeful, functional, streaming HTTP for Scala with WebSocket support.
* [ZIO HTTP](https://github.com/zio/zio-http) ⭐ 869 | 🐛 54 | 🌐 Scala | 📅 2026-08-18 - High-performance, functional Scala HTTP library with WebSocket support built on ZIO.
...
* [PartySocket](https://github.com/partykit/partykit/tree/main/packages/partysocket) ⭐ 5,686 | 🐛 92 | 🌐 TypeScript | 📅 2026-01-29 - Robust WebSocket client with automatic reconnection and buffering, usable against any WS server.
* [soketi](https://github.com/soketi/soketi) ⭐ 5,633 | 🐛 140 | 🌐 TypeScript | 📅 2025-03-03 - Just another simple, fast, and resilient open-source WebSockets server. Built on top of uWebSockets.js.
...
* [FastAPI](https://github.com/fastapi/fastapi) ⭐ 101,665 | 🐛 85 | 🌐 Python | 📅 2026-08-17 - Modern, high-performance web framework for building APIs, with first-class WebSocket support.
* [aiohttp](https://github.com/aio-libs/aiohttp) ⭐ 16,526 | 🐛 241 | 🌐 Python | 📅 2026-08-18 - Asynchronous HTTP client/server framework for asyncio, with built-in WebSocket client and server support.
...
* [python-socketio](https://github.com/miguelgrinberg/python-socketio) ⭐ 4,367 | 🐛 13 | 🌐 Python | 📅 2026-08-09 - Python implementation of the Socket.IO realtime client and server.
...
* [Autobahn.ws](https://github.com/crossbario/autobahn-python) ⭐ 2,542 | 🐛 187 | 🌐 Python | 📅 2026-07-15 - Open-source real-time framework for Web, Mobile & Internet of Things.
...
* [httpuv](https://cran.r-project.org/package=httpuv) - Provides low-level socket and protocol support for WebSocket (and HTTP) servers in R. Built on top of the [libuv](https://github.com/libuv/libuv) ⭐ 27,114 | 🐛 228 | 🌐 C | 📅 2026-08-17 and [http-parser](https://github.com/nodejs/http-parser) ⚠️ Archived C libraries.
...
* [Axum](https://github.com/tokio-rs/axum) ⭐ 26,898 | 🐛 76 | 🌐 Rust | 📅 2026-08-18 - Ergonomic and modular web framework built with Tokio, Tower, and Hyper, with built-in WebSocket support.
...
* [ntex](https://github.com/ntex-rs/ntex) ⭐ 2,528 | 🐛 2 | 🌐 Rust | 📅 2026-08-18 - Powerful, pragmatic and fast web framework with WebSocket support.
...
* [Tungstenite](https://github.com/snapview/tungstenite-rs) ⭐ 2,384 | 🐛 46 | 🌐 Rust | 📅 2026-07-11 - Lightweight stream-based WebSocket implementation
...
* [wtx](https://github.com/c410-f3r/wtx) ⭐ 397 | 🐛 8 | 🌐 Rust | 📅 2026-08-14 - Client and server with encryption support.
...
* [SwiftNIO](https://github.com/apple/swift-nio) ⭐ 8,508 | 🐛 288 | 🌐 Swift | 📅 2026-08-13 - Apple's cross-platform async event-driven network framework, a foundation for WebSocket servers.
...
* [Hummingbird](https://github.com/hummingbird-project/hummingbird) ⭐ 1,873 | 🐛 23 | 🌐 Swift | 📅 2026-08-17 - Lightweight, flexible Swift server framework on SwiftNIO with WebSocket support.
...
* [TikTok-Live-Connector](https://github.com/zerodytrash/TikTok-Live-Connector/) ⭐ 2,118 | 🐛 9 | 🌐 TypeScript | 📅 2026-08-18 - Open source TikTok LIVE stream events API, with delivery over WebSocket. The predominant & native TypeScript library for TikTok LIVE integrations.
* [TikTokLive](https://github.com/isaackogan/TikTokLive/) ⭐ 1,528 | 🐛 0 | 🌐 Python | 📅 2026-08-18 - A TikTok LIVE API Client built in Python, with strict mypy type safety & a copyleft license. Real-time TikTok LIVE stream events (gifts, chats, etc.) over WebSocket.
* [TikTokLiveJava](https://github.com/jwdeveloper/TikTokLiveJava) ⭐ 208 | 🐛 1 | 🌐 Java | 📅 2026-08-13 - A TikTok LIVE API Client built in Java. Real-time TikTok LIVE stream events (gifts, chats, etc.) over WebSockets.
...
* [PartyKit](https://github.com/partykit/partykit) ⭐ 5,686 | 🐛 92 | 🌐 TypeScript | 📅 2026-01-29 - Open-source platform for building realtime multiplayer apps on Cloudflare with a batteries-included WebSocket server abstraction.
...
* [react-use-websocket](https://github.com/robtaussig/react-use-websocket) ⭐ 1,887 | 🐛 95 | 🌐 TypeScript | 📅 2025-02-04 - React hook for WebSocket connections with reconnection, message queueing, and shared connections.
...
* [websocat](https://github.com/vi/websocat) ⭐ 8,662 | 🐛 158 | 🌐 Rust | 📅 2026-08-13 - Command-line client for WebSockets, like netcat (or curl) for ws\:// with advanced socat-like functions.
...
Please, read the [Contribution Guidelines](https://github.com/facundofarias/awesome-websockets/blob/master/CONTRIBUTING.md) ⭐ 1,858 | 🐛 3 | 📅 2026-08-17 before submitting your suggestion.

Feel free to [open an issue](https://github.com/facundofarias/awesome-websockets/issues) ⭐ 1,858 | 🐛 3 | 📅 2026-08-17 or [create a pull request](https://github.com/facundofarias/awesome-websockets/pulls) ⭐ 1,858 | 🐛 3 | 📅 2026-08-17 with your additions.
