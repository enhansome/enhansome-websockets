...
* [Centrifugo](https://github.com/centrifugal/centrifugo) ⭐ 10,707 | 🐛 25 | 🌐 Go | 📅 2026-09-01 - Scalable real-time messaging in language-agnostic way.
...
* [µWebSockets](https://github.com/uNetworking/uWebSockets) ⭐ 18,979 | 🐛 48 | 🌐 C++ | 📅 2026-08-29 -  Highly scalable WebSocket server library.
* [Drogon](https://github.com/an-tao/drogon) ⭐ 14,233 | 🐛 426 | 🌐 C++ | 📅 2026-08-27 - Fast C++14/17/20 HTTP application framework with built-in WebSocket controllers.
* [POCO](https://github.com/pocoproject/poco) ⭐ 9,484 | 🐛 129 | 🌐 C++ | 📅 2026-09-01 - C++ libraries for network-centric applications, including HTTP and WebSocket classes.
...
* [libhv](https://github.com/ithewei/libhv) ⭐ 7,543 | 🐛 40 | 🌐 C | 📅 2026-09-01 - A network library for developing TCP/UDP/SSL/HTTP/WebSocket client/server.
* [Crow](https://github.com/CrowCpp/Crow) ⭐ 4,957 | 🐛 87 | 🌐 C++ | 📅 2026-08-31 - Fast and easy-to-use C++ microframework for the web, with WebSocket support.
...
* [Phoenix](https://github.com/phoenixframework/phoenix) ⭐ 23,135 | 🐛 47 | 🌐 Elixir | 📅 2026-09-02 - Productive Elixir web framework with Channels for realtime, scalable WebSocket communication.
* [Phoenix LiveView](https://github.com/phoenixframework/phoenix_live_view) ⭐ 6,826 | 🐛 26 | 🌐 Elixir | 📅 2026-09-01 - Rich, realtime server-rendered UIs over WebSockets without writing JavaScript.
...
* [Gorilla Websocket](https://github.com/gorilla/websocket) ⭐ 24,860 | 🐛 81 | 🌐 Go | 📅 2025-03-19 - WebSocket implementation for Go.
...
* [coder/websocket](https://github.com/coder/websocket) ⭐ 5,445 | 🐛 71 | 🌐 Go | 📅 2026-06-15 - A minimal and idiomatic WebSocket library for Go (formerly nhooyr/websocket).
...
* [Centrifuge](https://github.com/centrifugal/centrifuge) ⭐ 1,466 | 🐛 13 | 🌐 Go | 📅 2026-08-31 - Real-time messaging library for Go with scalability in mind.
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 131 | 🐛 45 | 🌐 TypeScript | 📅 2026-09-02 - AI-powered multi-cluster Kubernetes dashboard using WebSockets for real-time cluster communication and live observability streams.
...
* [Netty](https://github.com/netty/netty) ⭐ 35,040 | 🐛 657 | 🌐 Java | 📅 2026-09-02 - Asynchronous event-driven network framework with full WebSocket codec support.
* [Vert.x](https://github.com/eclipse-vertx/vert.x) ⭐ 14,685 | 🐛 228 | 🌐 Java | 📅 2026-09-02 - Reactive, polyglot toolkit for the JVM with first-class WebSocket client and server APIs.
...
* [Jetty](https://github.com/jetty/jetty.project) ⭐ 4,092 | 🐛 278 | 🌐 Java | 📅 2026-09-02 - Lightweight, embeddable Java web server and servlet container with Jakarta and native WebSocket support.
* [Atmosphere](https://github.com/Atmosphere/atmosphere) ⭐ 3,805 | 🐛 6 | 🌐 Java | 📅 2026-09-02 - Realtime Client Server Framework for the JVM, supporting WebSockets with Cross-Browser Fallbacks.
* [Undertow](https://github.com/undertow-io/undertow) ⭐ 3,760 | 🐛 46 | 🌐 Java | 📅 2026-09-01 - High-performance web server (WildFly's core) with a dedicated WebSocket API.
...
* [OkHttp](https://github.com/square/okhttp) ⭐ 47,059 | 🐛 143 | 🌐 Kotlin | 📅 2026-09-02 - HTTP client for the JVM and Android with a robust WebSocket client.
* [Ktor](https://github.com/ktorio/ktor) ⭐ 14,510 | 🐛 183 | 🌐 Kotlin | 📅 2026-09-01 - JetBrains' Kotlin async framework with built-in WebSocket client and server support.
...
* [ZIO HTTP](https://github.com/zio/zio-http) ⭐ 871 | 🐛 61 | 🌐 Scala | 📅 2026-09-02 - High-performance, functional Scala HTTP library with WebSocket support built on ZIO.
* [Apache Pekko HTTP](https://github.com/apache/pekko-http) ⭐ 196 | 🐛 73 | 🌐 Scala | 📅 2026-09-02 - Streaming WebSocket client and server directives; the Apache-licensed Akka HTTP fork.
...
* [uws](https://github.com/uNetworking/uWebSockets.js) ⭐ 9,151 | 🐛 23 | 🌐 C++ | 📅 2026-07-11 - Tiny WebSockets (access to the C++ library, µWebSockets, via Node.js)
* [PartySocket](https://github.com/partykit/partykit/tree/main/packages/partysocket) ⭐ 5,699 | 🐛 92 | 🌐 TypeScript | 📅 2026-01-29 - Robust WebSocket client with automatic reconnection and buffering, usable against any WS server.
...
* [FastAPI](https://github.com/fastapi/fastapi) ⭐ 102,016 | 🐛 81 | 🌐 Python | 📅 2026-09-01 - Modern, high-performance web framework for building APIs, with first-class WebSocket support.
* [aiohttp](https://github.com/aio-libs/aiohttp) ⭐ 16,535 | 🐛 217 | 🌐 Python | 📅 2026-09-02 - Asynchronous HTTP client/server framework for asyncio, with built-in WebSocket client and server support.
...
* [websocket-client](https://github.com/websocket-client/websocket-client) ⭐ 3,708 | 🐛 32 | 🌐 Python | 📅 2026-08-31 - Popular, long-standing synchronous client for Python.
...
* [httpuv](https://cran.r-project.org/package=httpuv) - Provides low-level socket and protocol support for WebSocket (and HTTP) servers in R. Built on top of the [libuv](https://github.com/libuv/libuv) ⭐ 27,148 | 🐛 231 | 🌐 C | 📅 2026-09-01 and [http-parser](https://github.com/nodejs/http-parser) ⚠️ Archived C libraries.
...
* [Rage](https://github.com/rage-rb/rage) ⭐ 1,409 | 🐛 21 | 🌐 Ruby | 📅 2026-09-01 - Fast WebSocket server compatible with Action Cable.
...
* [Axum](https://github.com/tokio-rs/axum) ⭐ 27,010 | 🐛 78 | 🌐 Rust | 📅 2026-09-01 - Ergonomic and modular web framework built with Tokio, Tower, and Hyper, with built-in WebSocket support.
...
* [ntex](https://github.com/ntex-rs/ntex) ⭐ 2,532 | 🐛 4 | 🌐 Rust | 📅 2026-09-01 - Powerful, pragmatic and fast web framework with WebSocket support.
* [Tokio-Tungstenite](https://github.com/snapview/tokio-tungstenite) ⭐ 2,499 | 🐛 18 | 🌐 Rust | 📅 2026-07-11 - Tokio binding for Tungstenite, the Lightweight stream-based WebSocket implementation
...
* [SwiftNIO](https://github.com/apple/swift-nio) ⭐ 8,511 | 🐛 295 | 🌐 Swift | 📅 2026-09-01 - Apple's cross-platform async event-driven network framework, a foundation for WebSocket servers.
...
* [TikTokLive](https://github.com/isaackogan/TikTokLive/) ⭐ 1,543 | 🐛 0 | 🌐 Python | 📅 2026-08-18 - A TikTok LIVE API Client built in Python, with strict mypy type safety & a copyleft license. Real-time TikTok LIVE stream events (gifts, chats, etc.) over WebSocket.
...
* [PartyKit](https://github.com/partykit/partykit) ⭐ 5,699 | 🐛 92 | 🌐 TypeScript | 📅 2026-01-29 - Open-source platform for building realtime multiplayer apps on Cloudflare with a batteries-included WebSocket server abstraction.
...
* [websocat](https://github.com/vi/websocat) ⭐ 8,682 | 🐛 158 | 🌐 Rust | 📅 2026-08-13 - Command-line client for WebSockets, like netcat (or curl) for ws\:// with advanced socat-like functions.
